          ...
          <div>
            ...
            <div className="flex items-center justify-between pt-4 ">
              <button
                type="submit"
                //   onClick={newac}
                className="group relative flex w-full justify-center font-medium text-indigo-600 hover:text-indigo-500"
              >
              ...
              <button
                type="submit"
                //   onClick={cancel}
                className=" relative flex w-full justify-center font-medium text-indigo-600 hover:text-indigo-500"
              >
                Cancel
              </button>
            </div>
